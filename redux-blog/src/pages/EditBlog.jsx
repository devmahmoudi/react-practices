        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    <input name="title" type="text" id="title" value={data.title} onChange={handleChange} />
                </div>
                <div className="form-group">
                    <label for="body">
                        متن :
                    </label>
                    <textarea name="body" id="body" rows={15} onChange={handleChange} value={data.body}></textarea>
                </div>
                <div className="form-group">
